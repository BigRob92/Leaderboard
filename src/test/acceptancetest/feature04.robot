...
| Test Click Leaderboard Lowest    | Start Application                 | edu.jsu.mcis.Gamegogy		      |                     |
...
| Test Click Leaderboard Highest   | Start Application                 | edu.jsu.mcis.Gamegogy   		  |                     |
|                                  | Select Window                     | Gamegogy                         |                     |
...
|                                  | Close Window                      | Gamegogy                         |                     |
| Test Click Leaderboard Middle    | Start Application                 | edu.jsu.mcis.Gamegogy   		  |                     |
|                                  | Select Window                     | Gamegogy                         |                     |
